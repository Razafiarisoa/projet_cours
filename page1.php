...
<body onload="showDate('ASIE')">
    ...
    <nav>
      <a href="page1.php">Asie</a>
      <a href="page2.php">Europe</a>
      <a href="page3.php">Amérique</a>
    ...
    <div class="esp">
        <img class="tailleimg" class="img1" src="https://flagcdn.com/h120/aw.png" alt="South Africa">
        <img class="tailleimg" class="img2" src="https://flagcdn.com/h120/gb.png" alt="South Africa">
